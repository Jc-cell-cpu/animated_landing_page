...
function Footer({}: Props) {
  return (
    <div className='dark'>
        <footer className='bg-zinc-50 dark:bg-zinc-950 text-zinc-700 dark:text-zinc-400 text-sm z-20'>
            ...
            <div className='w-full max-w-screen-xl mx-auto px-4 sm:px-8 lg:px-16 py-24 flex flex-col sm:flex-row gap-10 justify-between'>
                ...
                <span className='font-bold text-2xl text-white'>JC</span>
            </a>
                    <p className="leading-relaxed my-6">GODZILA<br/>Copyright © 2024 J Technologies Inc.</p>
